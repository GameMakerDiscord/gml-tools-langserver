...
/**
 * Takes an array which contains nulls or undefineds and returns
 * an array stripped of those nulls or undefineds. We use this
 * to clean our ReferenceArrays when we send them to VSC, since
 * VSC doesn't like nulls in these arrays.
 * @param thisArray The array which contains nulls or undefineds.
 */
